...
module ReactionAddEventHandlerPatch
  def matches?(event)
    return false unless event.is_a? Discordrb::Events::ReactionAddEvent
...
Discordrb::Events::ReactionAddEventHandler.include ReactionAddEventHandlerPatch
